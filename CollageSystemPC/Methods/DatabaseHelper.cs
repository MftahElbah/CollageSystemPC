    ...
    public class DatabaseHelper
    {
        ...
        private async Task SeedDatabase()
        {
            ...
            if(teacher.Count == 0){
                ...
                {
                    new UsersAccountTable {UserId=111111111,Name= "استاذ 1",Username = "t1" , Password="1" , UserType=1 , IsActive = true},
                    new UsersAccountTable {UserId=111111112,Name= "استاذ 6",Username = "t6" , Password="1" , UserType=1 ,IsActive = true},
                    new UsersAccountTable {UserId=111111113,Name= "استاذ 3",Username = "t3" , Password="1" , UserType=1 ,IsActive = true},
                    new UsersAccountTable {UserId=111111114,Name= "استاذ 4",Username = "t4" , Password="1" , UserType=1 ,IsActive = true},
                    new UsersAccountTable {UserId=111111115,Name= "استاذ 5",Username = "t5" , Password="1" , UserType=1 ,IsActive = true},
                    new UsersAccountTable {UserId=111111116,Name= "استاذ 2",Username = "t2" , Password="1" , UserType=1 ,IsActive = true},
                    ...
                    new UsersAccountTable {UserId=111111122,Name= "طالب 2",Username = "s3" , Password="1" , UserType=2 ,IsActive = true},
                    new UsersAccountTable {UserId=111111122,Name= "طالب 2",Username = "s4" , Password="1" , UserType=2 ,IsActive = true},
                    new UsersAccountTable {UserId=111111122,Name= "طالب 2",Username = "s5" , Password="1" , UserType=2 ,IsActive = true},
                    new UsersAccountTable {UserId=111111122,Name= "طالب 2",Username = "s566" , Password="1" , UserType=2 ,IsActive = true},
                };
